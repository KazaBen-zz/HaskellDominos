module Domino where
 ...
 -- Assignment 2
  ...
  playDomsRound p1 p2 seed = trace((show hand1) ++ " " ++ (show hand2))(playARound p1 p2 [] hand1 hand2, playARound p2 p1 (makeAMove p1 [] hand1) hand2 hand1) -- 2nd player starting board is board after 1st player's move
  ...
  playARound p1 p2 board h1 h2
    ...
    | otherwise = trace ("Putting " ++ show ( (p1 h1 board))++" Board: " ++ show (makeAMove p1 board h1)) snd (makeAMoveAndCalcScore p1 board h1) + playARound p1 p2 (makeAMove p2 (makeAMove p1 board h1) h2) h1 h2 -- add score and recursive call
  ...
  hsdPlayer_Test0 = hsdPlayer [(0,3), (2,4), (3,4), (6,2)] [(3,5), (5,4)] -- Result: ((0,3),L).Testing RIGHT end(Scores 2 points) 
  ...
  hsdPlayer_Test3 = hsdPlayer [(0,5), (0,6)] [(0,0)] -- Result: Just ((0,6),R). Testing if most scored domino will be placed(both can be).
  ...
  playDomsRound_Test2 = playDomsRound simplePlayer hsdPlayer 2 -- Result: (13,9)
  {--
  How the game is played:
    Hand1: [(3,3),(0,3),(1,4),(2,6),(3,4),(0,1),(0,4)] Hand2: [(3,6),(5,6),(5,5),(2,5),(1,1),(6,6),(0,5)]
    p1: Putting ((3,3),L) Board: [(3,3)]. Scores (4,0)
    p2: Putting ((3,6),R) Board: [(3,3),(3,6)]. Scores (4,4)
    p1: Putting ((0,3),L) Board: [(0,3),(3,3),(3,6)]. Scores (6,4)
    p2: Putting ((6,6),R) Board: [(0,3),(3,3),(3,6),(6,6)] Score 4. Scores (6,8)
    p1: Putting ((2,6),R) Board: [(0,3),(3,3),(3,6),(6,6),(6,2)] Score 0. Scores (6,8)
    p2: Putting ((2,5),R) Board: [(0,3),(3,3),(3,6),(6,6),(6,2),(2,5)] Score 1. Scores (6,9)
    p1: Putting ((0,1),L) Board: [(1,0),(0,3),(3,3),(3,6),(6,6),(6,2),(2,5)] Score 2. Scores (8,9)
    p2: Putting ((5,6),R) Board: [(1,0),(0,3),(3,3),(3,6),(6,6),(6,2),(2,5),(5,6)] Score 0. Scores (8,9)
    p1: Putting ((1,4),L) Board: [(4,1),(1,0),(0,3),(3,3),(3,6),(6,6),(6,2),(2,5),(5,6)] Score 2. Scores (10,9)
    p2: CAN'T PUT ANYTHING(SKIPS). Scores (10,9)
    p1: Putting ((3,4),L) Board: [(3,4),(4,1),(1,0),(0,3),(3,3),(3,6),(6,6),(6,2),(2,5),(5,6)] Score 3. Scores (13,9)
  --}
  ...
  p2: Putting ((2,5),L) Board: [(2,5),(5,5)]. Scores (2,0)
  p1: Putting ((2,6),L) Board: [(6,2),(2,5),(5,5)].  Scores (2,0)
  p1: Putting ((2,3),L) Board: [(2,3),(3,6),(6,2),(2,5),(5,5)].  Scores (,)
  p1: Putting ((1,1),L) Board: [(1,1),(1,2),(2,3),(3,6),(6,2),(2,5),(5,5)].  Scores (,)
  p1: Putting ((5,6),R) Board: [(1,1),(1,2),(2,3),(3,6),(6,2),(2,5),(5,5),(5,6)].  Scores (,)
  p1: Putting ((2,4),R) Board: [(1,1),(1,2),(2,3),(3,6),(6,2),(2,5),(5,5),(5,6),(6,4),(4,2)].  Scores (,)
  p2: Putting ((3,6),L) Board: [(3,6),(6,2),(2,5),(5,5)].  Scores (,)
  p2: Putting ((1,2),L) Board: [(1,2),(2,3),(3,6),(6,2),(2,5),(5,5)].  Scores (,)
  p2: Putting ((4,6),R) Board: [(1,1),(1,2),(2,3),(3,6),(6,2),(2,5),(5,5),(5,6),(6,4)].  Scores (,)
  --}
